...
const Featured = ({data}) => {
  ...
  return (
    <div className="featured0" style={{backgroundColor:themeColor.mood}}>
      <div className="top1">
        <h1 className="title1">{t("mails")}</h1>
        <MoreVertIcon fontSize="small" />
      </div>
      <div className="bottom1">
        <div className="featuredChart1">
          <CircularProgressbar value={parseInt((data?.mailStatisticsto[1].count/data?.mailStatisticstotal)*100)} text={parseInt((data?.mailStatisticsto[1].count/data?.mailStatisticstotal)*100)+"%"} strokeWidth={5} styles={buildStyles({
    ...
    trailColor: themeColor.main,
        ...
        <p className="title1">{t('Total Open Mail')}</p>
